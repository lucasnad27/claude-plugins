...
The checkpoint views come from HumanLayer's [show-me](https://github.com/humanlayer/skills/tree/main/plugins/show-me). Install it to get the same views on demand.
...
- **[show-me](https://github.com/humanlayer/skills/tree/main/plugins/show-me)** (MIT, by HumanLayer) — the checkpoint views, and picking the smallest one that makes the point
